...
CREDENTIAL_PATTERNS = [
    ...
    r"\bconfirm\s+(your\s+)?(account|login|credentials)\b",
    r"\breset\s+(your\s+)?password\b",
    r"\bsign\s*in\s+(to\s+)?(verify|confirm|update)\b",
    r"\benter\s+(your\s+)?(credentials|password|ssn)\b",
    r"\benable\s+macros\b",
]
